/**
 * @FilePath     : /mxChat/src/GateServer/GateLogic.cpp
 * @Description  :  
 * @Author       : caomengxuan666 2507560089@qq.com
 * @Version      : 0.0.1
 * @LastEditors  : caomengxuan666 2507560089@qq.com
 * @LastEditTime : 2025-03-05 21:51:52
...
void GateLogic::RegGet(std::string url, HttpHandler handler) {
    _get_handlers.insert(make_pair(url, handler));
}

void GateLogic::RegPost(std::string url, HttpHandler handler) {
    _post_handlers.insert(make_pair(url, handler));
}

bool GateLogic::HandleGet(std::string path, std::shared_ptr<HttpConnection> con) {
...
bool GateLogic::HandlePost(std::string path, std::shared_ptr<HttpConnection> con) {
